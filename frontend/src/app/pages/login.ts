  ...
  <div class="scr">
    ...
    <div class="scr-body">
      <div style="text-align:center;margin-top:6px">
        ...
        <p class="muted" style="font-size:13.5px;margin-top:6px;line-height:1.45">{{ i18n.t(mode() === 'collecteur' ? 'login_collecteur_sub' : 'login_sub') }}</p>
      </div>
...
export class LoginComponent {
  ...
  setMode(m: Mode) { if (this.mode() !== m) { this.mode.set(m); this.err.set(''); this.showPw.set(false); } }
