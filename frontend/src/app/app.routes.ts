...
export const routes: Routes = [
  ...
  // director / sales manager monitoring dashboard
  { path: 'dashboard', canActivate: [roleGuard('ADMIN', 'SUPERVISEUR')], loadComponent: () => import('./pages/dashboard').then((m) => m.DashboardComponent) },
